...
begin
  ...
  if (SelectedRow > 0) and OpenDialog1.Execute then
  begin
    ID := StrToInt(StringGrid1.Cells[0, SelectedRow]);
    ...
    try
      ...
      FDQuery1.Params.ParamByName('FileName').AsString := ExtractFileName(OpenDialog1.FileName);
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        TBlobField(FDQuery1.FieldByName('FileData')).SaveToStream(MemoryStream);
